...
<div region="north" style="height: 78px;background-color: #ffff">
    <table width="100%">
        <tr>
            <td width="50%" valig="bottom"
                align="left" style="font-size: 30px;color:#0d0d0d;font-family:'楷体';" >
...
<div region="center">
    <div class="easyui-tabs" fit="true" border="false" id="tabs">
        <div title="首页" data-options="iconCls:'icon-home'">
                    ...
                    href="http://www.lib.shu.edu.cn/"
                    target="_blank" style="font-size: 20px;">上海大学图书馆</a>
            </div>
            ...
            <div align="center" style="padding-top: 50px;"><a
                    href="https://github.com/wuyan2017"
                    target="_blank" style="font-size: 20px;">wuyan代码仓库</a>
            </div>
        </div>
    </div>
</div>
